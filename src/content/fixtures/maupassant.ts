...
const laParureUnitTexts = [
  ...
  "Elle souffrait sans cesse, se sentant née pour toutes les délicatesses et tous les luxes. Elle souffrait de la pauvreté de son logement, de la misère des murs, de l’usure des sièges, de la laideur des étoffes. Toutes ces choses, dont une autre femme de sa caste ne se serait même pas aperçue, la torturaient et l’indignaient. La vue de la petite Bretonne qui faisait son humble ménage éveillait en elle des regrets désolés et des rêves éperdus. Elle songeait aux antichambres muettes,",
  ...
  "Elle connut les gros travaux du ménage, les odieuses besognes de la cuisine. Elle lava la vaisselle, usant ses ongles roses sur les poteries grasses et le fond des casseroles. Elle savonna le linge sale, les chemises et les torchons, qu’elle faisait sécher sur une corde ;",
  "elle descendit à la rue, chaque matin, les ordures, et monta l’eau, s’arrêtant à chaque étage pour souffler. Et, vêtue comme une femme du peuple, elle alla chez le fruitier, chez l’épicier, chez le boucher, le panier au bras, marchandant, injuriée, défendant sou à sou son misérable argent.",
...
export const laParureThoughtUnits = laParureUnitTexts.map((french, index) => ({
  id: `unt_maupassant_parure_${String(index + 1).padStart(3, "0")}`,
  workId: "wrk_maupassant_la_parure",
  ordinal: index + 1,
  french,
}));

export const laParureCanonicalText = laParureThoughtUnits.map((unit) => unit.french).join("\n");

export const laParureSourceAcquisition: ContentBundle = {
  authors: [{ id: "aut_guy_de_maupassant", name: "Guy de Maupassant", sortName: "Maupassant, Guy de" }],
  collections: [{ id: "col_maupassant_contes_jour_nuit", authorId: "aut_guy_de_maupassant", title: "Contes du jour et de la nuit", language: "fr" }],
  books: [{ id: "bok_maupassant_contes_jour_nuit_1885", collectionId: "col_maupassant_contes_jour_nuit", ordinal: 1, title: "Édition Marpon et Flammarion, 1885" }],
  works: [{ id: "wrk_maupassant_la_parure", bookId: "bok_maupassant_contes_jour_nuit_1885", ordinal: 1, title: "La Parure", publicationState: "source_structured" }],
  sources: [{
    workId: "wrk_maupassant_la_parure",
    canonicalText: laParureCanonicalText,
    provenance: {
      citation: "Guy de Maupassant, « La Parure », Contes du jour et de la nuit, C. Marpon et E. Flammarion, 1885, p. 73–93",
